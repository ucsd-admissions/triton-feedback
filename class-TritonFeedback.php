...
class TritonFeedback{
	...
	public function register_frontend(){
		wp_register_script( 'angularjs', 'https://ajax.googleapis.com/ajax/libs/angularjs/1.2.28/angular.min.js', array(), null, true );
		wp_register_script( 'angular-cookies', 'https://ajax.googleapis.com/ajax/libs/angularjs/1.2.28/angular-cookies.js', array( 'angularjs' ), null, true );
